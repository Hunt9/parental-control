...
public class SwipeSelector extends FrameLayout {
    ...
    private void initializeViews(Context context) {
        ...
        pager = findViewById(R.id.swipeselector_layout_swipePager);
        indicatorContainer = findViewById(R.id.swipeselector_layout_circleContainer);
        leftButton = findViewById(R.id.swipeselector_layout_leftButton);
        rightButton = findViewById(R.id.swipeselector_layout_rightButton);
    }
